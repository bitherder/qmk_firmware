...
[_COLEMAK] = LAYOUT_ortho_4x12( \
  ...
  MO(_MOUSE), KC_LCTL, KC_LALT, KC_LGUI, LOWER,   KC_SPC,  KC_LCTL, RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
),
...
[_ARENSITO] = LAYOUT_ortho_4x12( \
  ...
  KC_ESC,         KC_A,    KC_R,    KC_E,    KC_N,        KC_B,         KC_G,    KC_S,         KC_I,    KC_T,    KC_O,    CTL_T(KC_ESC),         \
  MO(_ARE_SHIFT), KC_Z,    KC_W,    KC_DOT,  KC_H,        KC_J,         KC_V,    KC_C,         KC_Y,    KC_M,    KC_X,    LT(_ARE_SHIFT,KC_ENT), \
  MO(_MOUSE),     KC_LCTL, KC_LALT, KC_LGUI, MO(_ARE_LO), KC_SPC,       KC_LCTL, MO(_ARE_HI),  KC_RALT, KC_RGUI, KC_RCTL, MO(_MOUSE)             \
),
 ...
 * |      | Reset|      |      |      |      ||      |      |      |      |      |  Del |
 * |------+------+------+------+------+------||------+------+------+------+------+------|
 * |      |      |      |Aud on|Audoff|AGnorm||AGswap|Qwerty|Colemk|Dvorak|Arensi|      |
 * |------+------+------+------+------+------||------+------+------+------+------+------|
