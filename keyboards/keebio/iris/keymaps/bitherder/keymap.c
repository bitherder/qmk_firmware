...
// TAIPO COMBO SUPPORT
// ============================================================================
// Combo definitions for Taipo stenographic layout
...
enum combos { CM_S_E, CM_S_T, CM_S_O, CM_S_A, CM_LPRN, CM_LBRC, CM_LCBR, CM_LT, CM_S_I, CM_S_N, CM_S_S, CM_S_R, CM_RPRN, CM_RBRC, CM_RCBR, CM_GT, CM_H, CM_L, CM_Y, CM_B, CM_S_H, CM_S_L, CM_S_Y, CM_S_B, CM_0, CM_4, CM_5, CM_9, CM_G, CM_U, CM_D, CM_P, CM_S_G, CM_S_U, CM_S_D, CM_S_P, CM_HASH, CM_2, CM_AT, CM_7, CM_C, CM_Q, CM_F, CM_Z, CM_S_C, CM_S_Q, CM_S_F, CM_S_Z, CM_1, CM_3, CM_6, CM_8, CM_V, CM_X, CM_K, CM_J, CM_S_V, CM_S_X, CM_S_K, CM_S_J, CM_ASTR, CM_CIRC, CM_PLUS, CM_EQL, CM_MINS, CM_W, CM_M, CM_SLSH, CM_UNDS, CM_S_W, CM_S_M, CM_BSLS, CM_PERC, CM_AMPR, CM_DLR, CM_PIPE, CM_QUOT, CM_SCLN, CM_QUES, CM_COMMA, CM_DQT, CM_COLN, CM_EXLM, CM_DOT, CM_GRAVE, CM_TILDE, CM_ENTER, CM_TAB, CM_ESC, CM_DEL, CM_ALGR, CM_LEAD, CM_LGUI, CM_LALT, CM_LCTL, CM_LSFT, CM_RIGHT, CM_UP, CM_DOWN, CM_LEFT, CM_PGUP, CM_HOME, CM_END, CM_PGDN, CM_ADJUST };
